...
export default function Home() {
  return (
    <div id="" className="animate__animated animate__zoomIn animate__delay-1s">
    ...
    <h2 id="text09" class="style5 max-sm:mt-10 max-sm:text-center animate__animated animate__fadeInUp animate__delay-1s" style={{opacity: 1, transform: "none"}}>This might sound familiar to you:</h2>
    ...
    <div id="" className="style8 container w-2/3 ml-48 max-sm:w-96 max-sm:ml-6 ">
      <div className="wrapper">
        <div className="inner" data-onvisible-trigger="1">
          <h2 id="text08" className="style5 animate__animated animate__fadeInUp animate__delay-1s" style={{ opacity: 1, transform: 'none' }}>Except there’s a problem:</h2>
    ...
    <h2 id="" className=" text-white text-center text-3xl animate__animated animate__fadeInUp animate__delay-1s" style={{opacity: 1, transform: "none"}}>That's where I come in:</h2>
    <p id="" class="text-gray-300 text-center text-xl font-light mx-72 max-sm:mx-0 animate__animated animate__fadeInUp animate__delay-2s" style={{opacity: 1}}>I take care of your background operations, advise you, and support you - allowing you to scale and spend less time working on your business.</p>
    ...
    <div id="container08" className="style8 container default  w-2/3 ml-48 max-sm:w-96 max-sm:ml-6">
      <div className="wrapper">
        ...
        <div className="flex mb-10 max-sm:flex-col-reverse">
          ...
          <div className="w-1/2 max-sm:w-full animate__animated animate__slideInLeft animate__delay-1s">
          ...
          <div className="w-2/3 mt-20 max-sm:mt-5 max-sm:w-full animate__animated animate__bounceInUp animate__delay-1s">
      ...
      <div className="wrapper">
        <div className="inner" data-onvisible-trigger="1" data-reorder="0,1">
          <div>
            ...
            <p id="text12" className="style4 animate__animated animate__zoomInDown animate__delay-2s" style={{ opacity: 1 }}>
          ...
          <div>
            <div id="image06" className="style5 image max-sm:ml-20 animate__animated animate__slideInRight animate__delay-1s" style={{ opacity: 1, transform: 'none' }}>
    ...
    <li style={{ opacity: 1, transform: 'none' }}>
      <a className="n01 animate__animated animate__zoomInDown animate__delay-1s" href="https://twitter.com/JanisMjartans" aria-label="Twitter">
    ...
    <li style={{ opacity: 1, transform: 'none' }}>
      <a className="n02 animate__animated animate__zoomInDown animate__delay-2s" href="https://www.linkedin.com/in/janismjartans/" aria-label="LinkedIn">
    ...
    <li style={{ opacity: 1, transform: 'none' }}>
      <a className="n03 animate__animated animate__zoomInDown animate__delay-3s" href="mailto:janis@example.com" aria-label="Email">
  ...
  <p id="text04" class="style1 animate__animated animate__fadeIn  animate__delay-1s " style={{opacity: 1}}>hello@mypaidcommunity.com</p>
